...
| BUG-007 | Duplicate command definitions in opencode.json and .opencode/commands/ | P1 | resolved | phase-1-vectorless-rag | Removed `command` block from opencode.json; commands served from `.opencode/commands/*.md` |
